...
SELECT a.an_id, a.an_name, a.an_price, o.ord_id, o.ord_datetime, o.ord_an
FROM orders o
LEFT JOIN analysis a
ON a.an_group = o.ord_an;

SELECT a.an_id, a.an_name, a.an_price, o.ord_datetime
FROM orders o
LEFT JOIN analysis a
ON a.an_group = o.ord_an
WHERE ord_datetime >= "2020-02-05 07:05:14" && ord_datetime <= "2020-02-12 07:35:38";